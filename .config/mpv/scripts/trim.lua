...
local function initializeIfNeeded()
    ...
    mp.add_forced_key_binding("", "toggle-strip-metadata", function()
    ...
    if isVideoFile then
        ...
        mp.add_forced_key_binding("", "-0.1_keyframes", function()
            seekByKeyframes(-0.1)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "0.1_keyframes", function()
            seekByKeyframes(0.1)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "10_keyframes", function()
            seekByKeyframes(10)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "-10_keyframes", function()
            seekByKeyframes(-10)
        ...
        mp.add_forced_key_binding("", "-0.1_seconds", function()
            seekBySeconds(-0.1)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "0.1_seconds", function()
            seekBySeconds(0.1)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "0.5_seconds", function()
            seekBySeconds(0.5)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "-0.5_seconds", function()
            seekBySeconds(-0.5)
        ...
        mp.add_forced_key_binding("", "-1_seconds", function()
            seekBySeconds(-1)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "1_seconds", function()
            seekBySeconds(1)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "5_seconds", function()
            seekBySeconds(5)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "-5_seconds", function()
            seekBySeconds(-5)
        ...
        mp.add_forced_key_binding("", "-10_seconds", function()
            seekBySeconds(-10)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "10_seconds", function()
            seekBySeconds(10)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "30_seconds", function()
            seekBySeconds(30)
        end, {repeatable = true})
        mp.add_forced_key_binding("", "-30_seconds", function()
            seekBySeconds(-30)
    ...
    mp.add_forced_key_binding("Shift+Y", "seek-to-start-position", function()
        mp.commandv("seek", startPosition, "absolute")
        mp.command("show-progress")
        updateTrimmingPositionsOSDASS()
    end)
    mp.add_forced_key_binding("Shift+I", "seek-to-end-position", function()
...
-- Static Key Bindings
--
mp.add_key_binding("y", "trim-set-start-position", setStartPosition)
mp.add_key_binding("i", "trim-set-end-position", setEndPosition)
